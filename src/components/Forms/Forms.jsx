                    ...
                    <div className="col-lg-10 col-xl-9 mx-auto">
                        <div className="card bg-color-form flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                            <div className="card-body p-4 p-sm-5">
                                <h5 className="card-title text-center mb-5 fw-light fs-3">{t("turnos.title")}</h5>
                                {logged? <FormsLogged></FormsLogged> : <FormsNotLogged></FormsNotLogged>}
                            </div>
                        </div>
                    </div>
                </div>
...
const FormsNotLogged = () => {
    const[t] = useTranslation("global");
    return(
    <div className='bg-primary-subtle p-5'>
        <h4 className='fs-4'>{t("turnos.text")}</h4>
        <a className="d-block text-center mt-4 fs-5" href="/login">{t("turnos.login")}</a>
    </div>
  )}
